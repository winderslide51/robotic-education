...
.hint b { display: inline-block; min-width: 1.3em; border-radius: 6px; background: #394060; color: #fff; text-align: center; }
...
.retry { font-size: 1.1rem; font-weight: 700; padding: 12px 28px; border: none; border-radius: 999px; background: #ff8a3d; color: #fff; box-shadow: 0 4px 12px rgba(255, 138, 61, 0.4); }
...
.axis.on { background: #fff4c2; box-shadow: inset 0 0 0 2px #f5a800; }
...
.name b { flex: none; display: inline-flex; justify-content: center; align-items: center; width: 1.35em; height: 1.35em; border-radius: 50%; background: #394060; color: #fff; font-size: 0.7rem; }
.axis.on .name b { background: #f5a800; }
...
input[type='range']::-webkit-slider-runnable-track { height: 8px; border-radius: 999px; background: #d5d9e2; }
input[type='range']::-moz-range-track { height: 8px; border-radius: 999px; background: #d5d9e2; }
input[type='range']::-webkit-slider-thumb { -webkit-appearance: none; appearance: none; width: 28px; height: 28px; margin-top: -10px; border-radius: 50%; background: #394060; border: 3px solid #fff; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.3); }
input[type='range']::-moz-range-thumb { width: 22px; height: 22px; border-radius: 50%; background: #394060; border: 3px solid #fff; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.3); }
.axis.on input[type='range']::-webkit-slider-thumb { background: #f5a800; }
.axis.on input[type='range']::-moz-range-thumb { background: #f5a800; }
